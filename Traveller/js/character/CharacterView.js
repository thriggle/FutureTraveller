...
function newCharacter() {
    ...
    if (document.querySelector("input[name='homeworld']:checked").value === "choose") {
        ...
        if (slctHomeworld.selectedIndex >= 0 && slctHomeworld.options.length > 0) {
            var option = slctHomeworld.options[slctHomeworld.selectedIndex];
            ...
            person.setHomeworld({
                ...
                sector: slctSector.options[slctSector.selectedIndex].innerText,
                milieu: slctMilieu.options[slctMilieu.selectedIndex].innerText,
                sectorId: slctSector.value,
