...
export function getNames(){
    ...
    "ship":{
        ...
        "royalnavyi":[
            "Ibis","Icarus","Icicle","Ickford","Ignition","Ildefonso","Ilex","Ilfracombe","Illustrious","Ilmington","Ilston","Imaum","Immortalite","Imogen","Imogene","Imperial","Imperieuse","Impeteux","Impey","Implacable","Impregnable","Impregnable I","Impregnable II","Impregnable III","Impregnable IV","Impulsive","Incendiary","Inconstant","Increase","Indefatigable","Independencia","India","Indian","Indignant","Indomitable","Indus","Indus II","Indus III","Indus IV","Indus V","Industry","Infanta Don Carlos","Infanta","Infernal","Inflexible","Inglefield","Inglesham","Inglis","Ingonish","Inman","Insolent","Inspector","Instow","Integrity","Intelligence","Intelligent","Intrepid","Invention","Invermoriston","Inverness","Inverlyon","Investigator","Inveterate","Invicta","Invincible","Iolaire","Iphigenia","Ipswich","Iris","Iron Duke","Iroquois","Irresistible","Irvine","Irwell","Isabella","Isham","Isinglass","Isis","Iskra","Islay","Isle of Guernsey","Isle of May","Isle of Thanet","Isle of Wight","Islip","Ister","Itchen","Ithuriel","Ivanhoe","Iveston","Ivy"
        ],
        "royalnavyj":[
