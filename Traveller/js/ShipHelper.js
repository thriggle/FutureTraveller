...
export class ENUM_HULL_FITTINGS {
    static get FlotationHull() { return { name: "Flotation Hull", baseTL: 5, cost: 1, tons: 1, tonnageCanBeUsedForFuel: false, installable: ["Planetoid", "Unstreamlined", "Streamlined", "Airframe"], automatic: ["Lifting Body"], removableFromAutoInstall: false, comment: "Sealed against prolonged fluid exposure, the flotation hull permits water landing and takeoff." } }
    static get SubmergenceHull() { return { name: "Submergence Hull", baseTL: 6, cost: 2, tons: 2, tonnageCanBeUsedForFuel: false, installable: ["Planetoid", "Unstreamlined", "Streamlined", "Airframe", "Lifting Body"], automatic: [], removableFromAutoInstall: false, comment: "Sealed against prolonged fluid exposure, the submergence hull gives the ability to submerge and resurface in addition to permitting water landing and takeoff. Doubles the effectiveness of hull armor vs pressure." } }
    static get Fins() { return { name: "Fins", baseTL: 5, cost: 0.5, tons: 2, tonnageCanBeUsedForFuel: true, installable: ["Unstreamlined", "Streamlined", "Lifting Body"], automatic: ["Airframe"], removableFromAutoInstall: false, comment: "Fins increase Agility +1 in worlds with Atmo 2+." } }
    static get FoldingFins() { return { name: "Folding Fins", baseTL: 8, deployedTons: 2, cost: 0.5, tons: 0, tonnageCanBeUsedForFuel: false, installable: ["Unstreamlined", "Streamlined"], automatic: [], removableFromAutoInstall: false, comment: "Fins increase Agility +1 in worlds with Atmo 2+. Folding fins only contribute to displacement tonnage when deployed." } }
    static get Wings() { return { name: "Wings", baseTL: 7, cost: 1, tons: 5, tonnageCanBeUsedForFuel: true, installable: ["Unstreamlined", "Streamlined"], automatic: ["Airframe", "Lifting Body"], removableFromAutoInstall: false, comment: "Wings increase Speed by 1G in worlds with Atmo 2+." } }
    static get FoldingWings() { return { name: "Folding Wings", baseTL: 9, deployedTons: 5, cost: 2, tons: 1, tonnageCanBeUsedForFuel: false, installable: ["Unstreamlined", "Streamlined"], automatic: [], removableFromAutoInstall: false, comment: "Wings increase Speed by 1G in worlds with Atmo 2+. Folding wings consume significantly less displacement tonnage when retracted." } }
    static get LandingSkids() { return { name: "Landing Skids", baseTL: 7, cost: 0, tons: 0, tonnageCanBeUsedForFuel: false, installable: ["Cluster", "Braced", "Planetoid", "Unstreamlined", "Airframe"], automatic: ["Streamlined", "Lifting Body"], removableFromAutoInstall: false, comment: "Default landing skids are weight-bearing horizontal bars, retractable, which require a solid tarmac or bedrock landing site." } }
    static get LandingLegsWithPads() { return { name: "Landing Legs with Pads", baseTL: 8, cost: 1, tons: 1, tonnageCanBeUsedForFuel: false, installable: ["Cluster", "Braced", "Planetoid", "Unstreamlined", "Streamlined", "Airframe", "Lifting Body"], automatic: [], removableFromAutoInstall: false, comment: "Landing legs with pads permit wilderness landings on uneven terrain." } }
    static get LandingWheels() { return { name: "Landing Wheels", baseTL: 5, cost: 1.5, tons: 3, tonnageCanBeUsedForFuel: false, installable: ["Cluster", "Braced", "Planetoid", "Unstreamlined", "Streamlined", "Lifting Body"], automatic: ["Airframe"], removableFromAutoInstall: false, comment: "Retractable landing wheels permit glide landing/takeoff from solid airstrips. Required when using wings for liftoff or landing." } }
    static get Lifters() { return { name: "Lifters", baseTL: 8, cost: 0.5, tons: 0, tonnageCanBeUsedForFuel: false, installable: [], automatic: ["Cluster", "Braced", "Planetoid", "Unstreamlined", "Streamlined", "Airframe", "Lifting Body"], removableFromAutoInstall: true, comment: "Lifters provide limited and slow hover capability." } }
}
